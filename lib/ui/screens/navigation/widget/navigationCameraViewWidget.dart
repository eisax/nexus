...
import 'package:nexus/ui/screens/navigation/widget/navigationOverlayWidget.dart';
import 'package:nexus/ui/screens/scan/widget/scanScreenWidget.dart';

class NavigationCameraView extends StatefulWidget {
  const NavigationCameraView({super.key});

  @override
  _NavigationCameraViewState createState() => _NavigationCameraViewState();
}

class _NavigationCameraViewState extends State<NavigationCameraView>
